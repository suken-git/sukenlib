...
#define RED  GetColor( 255 , 0 , 0 )///<  @brief 説明
#define GREEN  GetColor( 0 , 255 , 0 )///<  @brief 説明
#define BLUE  GetColor( 0 , 0 , 255 )///<  @brief 説明
#define BLACK  GetColor( 0 , 0 , 0 )///<  @brief 説明
#define WHITE  GetColor( 255 , 255 , 255 )///<  @brief 説明
#define GRAY  GetColor( 128 , 128 , 128 )///<  @brief 説明
#define LIGHTBLUE  GetColor( 128 , 128 , 255 )///<  @brief 説明
#define LIGHTGREEN  GetColor( 128 , 255 , 128 )///<  @brief 説明
#define M_PINK  GetColor( 255 , 128 , 128 )///<  @brief 説明
#define YELLOW  GetColor( 255 , 255 , 0)///<  @brief 説明
